...
function Porsche(props: any) {
  const { scene, nodes, materials }: any = useGLTF('/911-transformed.glb');
  useMemo(() => {
...
function CameraRig({ v = new THREE.Vector3() }: any) {
